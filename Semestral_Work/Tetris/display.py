...
class Draw:
    ...
    def drawStartScreen(self, board):
        ...
        pressText = gameFont.render("PRESS P TO PLAY", True, self.fontColour)
        text_width, text_height = pressText.get_size()
        center_x = (self.screen.get_width() - text_width) // 2
        y_coordinate = ((board.height / 2) - 3) * self.window.blockSize
        self.screen.blit(pressText, (center_x, y_coordinate))
